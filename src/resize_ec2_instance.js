(params) => {
  ...
  api.run("this.check_if_ec2_operation_completed", { instanceId: params.instanceId, stateLookingFor: "stopped", operationToCall: "this.resizeInstance", operationParams: resizeInstanceParams});
