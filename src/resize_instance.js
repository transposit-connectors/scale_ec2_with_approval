(params) => {
  ...
  if (result.success) {
    ...
    api.run("this.check_if_ec2_operation_completed", { instanceId: params.instanceId, stateLookingFor: "running", operationToCall: "this.resize_complete", operationParams: resizeCompleteParams});
  }}
}
